...
\twocolumncodenamed{code/rc10raii/ex.h}{code/rc10raii/ex.cpp}
\end{frame}
...
\twocolumncodenamed{code/rc10dtor1/classes.h}{code/rc10dtor1/driver.cpp}
\end{frame}

\begin{frame}[fragile]{Dtor examples: Double Free}
The following code causes double free problem.
\twocolumncodenamed{code/rc10dtor1/ex2.h}{code/rc10dtor1/ex2.cpp}
\end{frame}

\begin{frame}[fragile]{Dtor examples: Free only what you ``own"}
This is our correct solution.
\twocolumncodenamed{code/rc10dtor1/ex3.h}{code/rc10dtor1/ex3.cpp}
\end{frame}
